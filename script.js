...
/*localStorage.setItem("coins", 111110);
localStorage.setItem("attacklvl", 121);
localStorage.setItem("speedlvl",121);*/
...
document.addEventListener("keydown", function(event) {
  ...
  if(event.key.toLowerCase() === "c"){
    if (hitbox == false){
      ...
      document.getElementById("playercontainer").style.border = '2px solid blue';
      hitbox = true;
    }
    else{
      shitbox.style.border ='0px solid red';
      document.getElementById("playercontainer").style.border = '0px solid blue';
      hitbox = false;
    }
  }
  if(!dead){
